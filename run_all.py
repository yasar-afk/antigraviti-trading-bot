# ============================================================
# run_all.py — ANTIGRAVITI Multi-Version Launcher
#
# AMAÇ:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="ANTIGRAVITI Multi-Version Launcher — V2.1 + V3 + V4 aynı anda"
    )
    parser.add_argument(
...
def main() -> None:
    ...
    print("=" * 65)
    print("[*] ANTIGRAVITI MULTI-VERSION LAUNCHER")
    print("=" * 65)
