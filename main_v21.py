# ============================================================
# main_v21.py — ANTIGRAVITI Trading Bot v2.1
#
# AMAÇ:
#   v2.1 stratejisi için ana giriş noktası.
#   v2.1 = v2 politikası + SHORT işlem desteği
#   config_v21.yaml kullanır, logs_v21/ dizinine yazar.
#
# ÇALIŞTIRMA:
#   python main_v21.py                    # Döngü modu
#   python main_v21.py --single-run       # Tek seferlik
#   python main_v21.py --top-50           # Top 50 coin tara
# ============================================================

from __future__ import annotations

import os
os.environ["LOG_DIR"] = "logs_v21"
os.environ["CONFIG_FILE"] = "config_v21.yaml"
...
logger = get_logger("trading-bot.main_v21")

CONFIG_FILE = "config_v21.yaml"
VERSION_LABEL = "v2.1"


def load_v21_settings() -> Settings:
    """config_v21.yaml'dan v2.1 settings yükler (lru_cache bypass)."""
    ...
    # v2.1 versiyonunu açıkça zorla
    cfg.strategy.version = "v2.1"
    return cfg


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="ANTIGRAVITI v2.1 — Long + Short Algo Trading"
    )
...
def main() -> None:
    args = parse_args()
    cfg = load_v21_settings()

    logger.info("=" * 60)
    logger.info(f"🚀 ANTIGRAVITI {VERSION_LABEL} — Long + Short Bot Başlatılıyor")
    logger.info("=" * 60)
