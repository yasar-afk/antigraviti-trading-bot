# ANTIGRAVITI Algoritmik Ticaret Botu - Strateji Dokümanı (v2.0 & v2.1)

Bu doküman, ANTIGRAVITI Algo Trading Bot'un (v2.0 ve v2.1 sürümleri) işlem açma ve kapama kararlarını alırken kullandığı tüm matematiksel kuralları, indikatör ağırlıklarını, risk yönetimi prensiplerini ve son eklenen **Fibonacci & Formasyon (Pattern)** sistemlerini içermektedir.
